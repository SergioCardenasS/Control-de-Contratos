...
NEW_AREA_LOGISTICA_PASS			= ""
NEW_AREA_CALIDAD_PASS			= ""
...
new_area=area.Area([AREA_CONTROL_LOGISTICA_ID,AREA_CONTROL_LOGISTICA_NAME,NEW_AREA_LOGISTICA_PASS])
new_area.update(cursor)

new_area=area.Area([AREA_CONTROL_CALIDAD_ID,AREA_CONTROL_CALIDAD_NAME,NEW_AREA_CALIDAD_PASS])
new_area.update(cursor)
