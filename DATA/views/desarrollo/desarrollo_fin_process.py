...
class FinishProcessReviewData(QDialog):
	def __init__(self, contract, parent=None):
		super(FinishProcessReviewData, self).__init__(parent)
		self.contract=contract
		#crear la ventana
		self.finishProcessReviewDataWindow()
	...
	def finishProcessReviewDataWindow(self):
		#Nombre de los campos
		#Creacion de botones
		self.crearBoton = QPushButton("Datos Actualizados", self)
		...
		self.connect(self.crearBoton, SIGNAL("clicked()"), self.FinishSendIngenieria)

	def FinishSendIngenieria(self):
